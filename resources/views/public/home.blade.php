...
@section('title', 'Borderless Liquidity Grid')
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid lg:grid-cols-3 gap-8 items-stretch">
                <div class="bg-white rounded-[2rem] p-8 border border-slate-200 hover:shadow-xl transition-all flex flex-col group">
                    ...
                    <a href="{{ route('register') }}" class="block w-full text-center bg-white border-2 border-slate-200 text-slate-700 px-6 py-4 rounded-xl font-bold mt-auto hover:border-korie-green hover:text-korie-teal transition-colors">
                ...
                <div class="bg-slate-900 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden flex flex-col transform lg:-translate-y-4">
                    ...
                    <a href="{{ route('register') }}" class="block w-full text-center bg-gradient-to-r from-korie-green to-korie-teal text-white px-6 py-4 rounded-xl font-bold mt-auto relative z-10 hover:shadow-lg hover:shadow-korie-green/20 transition-all active:scale-[0.98]">
                        <span x-show="lang === 'en'">Become an Agent</span>
                        <span x-show="lang === 'fr'" x-cloak>Devenir Agent</span>
                        <span x-show="lang === 'ha'" x-cloak>Zama Wakili</span>
                    </a>
                ...
                <div class="bg-white rounded-[2rem] p-8 border border-slate-200 hover:shadow-xl transition-all flex flex-col group">
                    ...
                    <a href="{{ route('support.contact') }}" class="block w-full text-center bg-white border-2 border-slate-200 text-slate-700 px-6 py-4 rounded-xl font-bold mt-auto hover:border-korie-green hover:text-korie-teal transition-colors">
