...
<head>
    ...
    <title>KoriePay | <?php echo $__env->yieldContent('title', 'Borderless Liquidity Grid'); ?></title>
...
<body class="font-sans antialiased bg-slate-50 text-slate-900 selection:bg-korie-green selection:text-white" x-data="{ mobileMenuOpen: false, lang: 'en' }">
    ...
    <nav class="sticky top-0 z-50 bg-white/95 backdrop-blur-lg border-b border-slate-200">
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-2 z-50">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-cloak x-transition.opacity.duration.200ms class="absolute top-[100%] left-1/2 -translate-x-1/2 w-[600px] bg-white border border-slate-200 rounded-2xl shadow-xl p-6 grid grid-cols-2 gap-6">
                        <a href="<?php echo e(route('solutions.p2p')); ?>" class="group block p-4 rounded-xl hover:bg-slate-50 transition">
                        ...
                        <a href="<?php echo e(route('solutions.agency')); ?>" class="group block p-4 rounded-xl hover:bg-slate-50 transition">
                        ...
                        <a href="<?php echo e(route('solutions.adashi')); ?>" class="group block p-4 rounded-xl hover:bg-slate-50 transition">
                        ...
                        <a href="<?php echo e(route('solutions.islamic')); ?>" class="group block p-4 rounded-xl hover:bg-slate-50 transition">
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-cloak x-transition.opacity.duration.200ms class="absolute top-[100%] left-0 w-[250px] bg-white border border-slate-200 rounded-2xl shadow-xl p-3">
                        <a href="<?php echo e(route('developers.docs')); ?>" class="block p-3 rounded-lg hover:bg-slate-50 font-medium text-sm text-slate-700 hover:text-korie-green transition">API Documentation</a>
                        <a href="<?php echo e(route('developers.api')); ?>" class="block p-3 rounded-lg hover:bg-slate-50 font-medium text-sm text-slate-700 hover:text-korie-green transition">API Reference</a>
                        <a href="<?php echo e(route('developers.status')); ?>" class="block p-3 rounded-lg hover:bg-slate-50 font-medium text-sm text-slate-700 hover:text-korie-green transition flex justify-between">System Status <span class="w-2 h-2 rounded-full bg-korie-green self-center shadow-lg shadow-korie-green/20"></span></a>
                    </div>
                </div>

                <a href="<?php echo e(route('pricing')); ?>" class="text-slate-700 hover:text-korie-green transition font-bold text-sm">Pricing</a>
                <a href="<?php echo e(route('company.about')); ?>" class="text-slate-700 hover:text-korie-green transition font-bold text-sm">Company</a>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="hidden md:block text-slate-700 hover:text-korie-green transition font-bold text-sm">Sign In</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-korie-green to-pale-blue text-white px-5 py-2.5 rounded-lg font-bold hover:shadow-lg hover:shadow-korie-green/20 transition active:scale-95 text-sm">
                    Access Grid
                </a>
        ...
        <div x-show="mobileMenuOpen" x-cloak x-transition class="lg:hidden border-t border-slate-100 bg-white absolute w-full shadow-2xl overflow-y-auto max-h-[80vh]">
            <div class="px-6 py-4 space-y-2 flex flex-col">
                ...
                <a href="<?php echo e(route('solutions.agency')); ?>" class="font-bold text-slate-700 py-2">Agency Banking</a>
                <a href="<?php echo e(route('solutions.p2p')); ?>" class="font-bold text-slate-700 py-2">Borderless P2P</a>
                
                <div class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 mt-4">Developers</div>
                <a href="<?php echo e(route('developers.docs')); ?>" class="font-bold text-slate-700 py-2">API Documentation</a>
                
                <div class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 mt-4">Company</div>
                <a href="<?php echo e(route('pricing')); ?>" class="font-bold text-slate-700 py-2">Pricing</a>
                <a href="<?php echo e(route('company.about')); ?>" class="font-bold text-slate-700 py-2">About Us</a>
                <a href="<?php echo e(route('trust.security')); ?>" class="font-bold text-slate-700 py-2">Security & Trust</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-16">
                ...
                <div class="col-span-2 lg:col-span-2 pr-10">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-2 mb-6">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-500 font-medium">
                        <li><a href="<?php echo e(route('solutions.p2p')); ?>" class="hover:text-korie-green transition">Borderless P2P</a></li>
                        <li><a href="<?php echo e(route('solutions.agency')); ?>" class="hover:text-korie-green transition">Agency Banking</a></li>
                        <li><a href="<?php echo e(route('solutions.adashi')); ?>" class="hover:text-korie-green transition">Adashi Pools</a></li>
                        <li><a href="<?php echo e(route('pricing')); ?>" class="hover:text-korie-green transition">Pricing & Fees</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-500 font-medium">
                        <li><a href="<?php echo e(route('developers.docs')); ?>" class="hover:text-korie-green transition">API Documentation</a></li>
                        <li><a href="<?php echo e(route('developers.api')); ?>" class="hover:text-korie-green transition">API Reference</a></li>
                        <li><a href="<?php echo e(route('developers.status')); ?>" class="hover:text-korie-green transition">System Status</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-500 font-medium">
                        <li><a href="<?php echo e(route('company.about')); ?>" class="hover:text-korie-green transition">About Us</a></li>
                        <li><a href="<?php echo e(route('company.careers')); ?>" class="hover:text-korie-green transition">Careers <span class="bg-korie-green/10 text-korie-green px-2 py-0.5 rounded text-[10px] uppercase font-bold ml-1">Hiring</span></a></li>
                        <li><a href="<?php echo e(route('support.blog')); ?>" class="hover:text-korie-green transition">Insights (Blog)</a></li>
                        <li><a href="<?php echo e(route('company.press')); ?>" class="hover:text-korie-green transition">Press/Newsroom</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-500 font-medium">
                        <li><a href="<?php echo e(route('trust.security')); ?>" class="hover:text-korie-green transition">Security Posture</a></li>
                        <li><a href="<?php echo e(route('trust.compliance')); ?>" class="hover:text-korie-green transition">Licenses (CBN/BCEAO)</a></li>
                        <li><a href="<?php echo e(route('trust.privacy')); ?>" class="hover:text-korie-green transition">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('trust.terms')); ?>" class="hover:text-korie-green transition">Terms of Service</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-400 text-sm font-medium">&copy; <?php echo e(date('Y')); ?> KoriePay Liquidity Systems. All rights reserved.</p>
            </div>
        </div>
    </footer>

</body>
</html><?php /**PATH /home/user/koriepay_rebuild/resources/views/layouts/public.blade.php ENDPATH**/ ?>